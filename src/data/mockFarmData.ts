...
export const FARM_LOCATION_PRESETS: LocationPreset[] = [
  {
    id: 'fresno-ca',
    name: 'San Joaquin Valley Farm',
    region: 'California',
    country: 'United States',
    lat: 36.7468,
    lon: -119.7726,
    climateDesc: 'Mediterranean / Semi-Arid (High Solar, Low Rainfall)',
  },
  {
    id: 'almeria-spain',
    name: 'Andalusia Agro-Park',
    region: 'Almería',
    country: 'Spain',
    lat: 36.8381,
    lon: -2.4597,
    climateDesc: 'Hot-Summer Mediterranean (Intensive Precision Horticulture)',
  },
  {
    id: 'punjab-india',
    name: 'Ludhiana AgTech Hub',
    region: 'Punjab',
    country: 'India',
    lat: 30.901,
    lon: 75.8573,
    climateDesc: 'Subtropical Monsoon (Critical Aquifer Conservation)',
  },
  {
    id: 'nile-egypt',
    name: 'Delta Precision Fields',
    region: 'Kafr El Sheikh',
    country: 'Egypt',
    lat: 31.1107,
    lon: 30.9388,
    climateDesc: 'Arid Desert Margin (Extreme Evaporation Pressure)',
  },
  {
    id: 'mendoza-argentina',
    name: 'Uco Valley Vineyards',
    region: 'Mendoza',
    country: 'Argentina',
    lat: -33.585,
    lon: -69.043,
    climateDesc: 'High-Altitude Continental (Glacial Runoff Dependent)',
  },
];
